    ...
    <>
      ...
      <motion.div
        ...
        <div className="grid grid-cols-12 gap-4 h-84.5vh ml-4 sm:mx-12 md:mx-16">
          ...
          <div className="hidden md:flex md:col-span-5 lg:col-span-6 text-justify text-white justify-center items-center ">
            <img
              src={personalDetails.profile_img}
              alt="Noel Manabat"
              className="mx-auto w-50 lg:w-5/5 pointer-events-none text-right rounded-full"
            />
          </div>
        </div>
      </motion.div>
