          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4 relative">
              ...
              <h1 className="sm:w-4/5 mb-3 mt-1 text-7xl sm:text-5xl md:text-7xl lg:text-5xl font-normal tracking-wide text-white leading-normal lg:leading-7">
                He is providing technical insight and engineering support on companies and customers
                from different industries and helping them implementing their great ideas and
                thoughts in reality. He is continuing journey for being a proficient fullstack
                engineer mastered all spheres of web development.
              </h1>
              <h1 className="mb-3 mt-6 text-4xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-1xl font-extrabold text-white leading-none ">
                <span className="text-pink">Try.</span> Challenge. Dream will come true.
              </h1>
            </div>
          </div>
